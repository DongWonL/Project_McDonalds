			...
			/*]]>*/	
				...
				<div class="global-navbar navbar navbar-default" role="navigation">
					...
					<div class="alert alert-warning alert-dismissable inline-alert type-flama hidden alert-menuswitch-timeout" data-dismiss-trigger="wos.menuswitch.warning1.closed">
						...
						<p>
							<i class="fa fa-exclamation text-white icon"></i> <span>메뉴는 <span class="text-primary timer menuswitch-timer">41:43</span> 분 후에 종료됩니다. 종료 전에 주문을 완료해 주세요.</span>
						</p>
					</div>
				...
				<!-- Start of Session time out warning -->
						...
						<div class="alert alert-warning alert-dismissable inline-alert type-flama hidden alert-session-timeout" data-dismiss-trigger="session.action.continue">
							...
							<p>
								...
								선택하신 제품의 주문 가능 시간이 <span class="text-primary timer session-timer">14:49</span>분 남았습니다. 주문을 완료해 주세요.
							</p>
						</div>
							...
							<div class="modal-body">
								<div class="row">
									<div class="col-xs-3 timer-wrapper">
										...
										<div class="time timer text-din timer-clock menuswitch-timer">41:43</div>
							...
							<div class="modal-body">
								<div class="row">
									<div class="col-xs-3 timer-wrapper">
										...
										<div class="time timer text-din timer-clock storeclose-timer">51:43</div>
									</div>
									<div class="col-xs-8 timer-wrapper">
										<div class="alert-content text-left">
						...
						<ul class="primary-menu">
							...
							<li class="primary-menu-item selected"><a class="primary-menu-item-target" href="?daypartId=1"><span>일반 메뉴</span><i class="fa fa-angle-right"></i></a>
								<ul class="secondary-menu">
									<li class="secondary-menu-item "><a class="secondary-menu-item-target" href="Dlist.html?"><i class="fa fa-circle"></i> <span>추천 메뉴</span></a></li>
									<li class="secondary-menu-item selected"><a class="secondary-menu-item-target" href="?daypartId=1&amp;catId=11"><i class="fa fa-circle"></i> <span>버거 &amp; 세트</span></a></li>
						...
						<div class="col-xs-8">
							<div id="product-cards" class="product-cards" data-equal-height=".product-card--standard .product-title, .product-card--standard .product-info">
								<div class="row row-narrow">
									...
									<!-- 박민주 수정 -->
										<c:if test="${empty dmenulist }"><h3>데이터 없음</h3></c:if>   
										<c:if test="${not empty dmenulist }">   
										<c:forEach items="${dmenulist }" var="dto">     									
										<div class="product-card product-card--standard">
											<div class="panel panel-default panel-product">
												<div class="panel-body">
													<img src="${dto.img_path }" class="img-block">
													<h5 class="product-title" style="height: 15.3958px;">${dto.m_name }</h5>
												...
												<div class="panel-footer">
													<div class="row row-narrow">
														<div class="product-info" style="height: 57.4896px;">
															<div class="product-details">
																<div class="product-cost">
																	가격 <span class="starting-price">₩ ${dto.m_price }</span>
																</div>
																<div class="product-nutritional-info">
																	
																	
																		<a href="#" class="action-link" data-toggle="html-popover" data-placement="top" data-html="true" data-content-selector=".popover-details" data-original-title="" title="">
																			<i class="mcd icon mcd-detail"></i>
																				<span class="text-default">${dto.m_kcal }</span>
																...
																<div>
														<a href="#" class="action-link" data-toggle="html-popover" data-placement="bottom" data-html="true" data-content-selector=".popover-details" data-original-title="" title=""><i class="mcd icon mcd-allergen"></i> <span class="text-default">알레르기 정보</span></a>
														<div class="popover-details">
															<div class="popover-wrapper type-sans">
																<h4>${dto.m_name }</h4>
																<div>${dto.m_allergy }</div>
															</div>
														</div>
													</div>
													</div>
														...
														<div class="product-controls">
															...
															<!-- Point 1:  productClick - needs to be fixed. Pricing should not show currency or commas. The implementation can be found in Global GTM implementation guide page 26 and 27 -->
																...
																<a class="btn btn-block action-create btn-yellow action-startneworder" href="DlistModal.do?code=${dto.m_code}&name=${dto.m_name}"  >추가</a>
				...
				<tbody> 
					<tr>
						...
						<td>
							...
							<div>경기도 수원시 권선구 세류동(세류1동) 218-98 세류</div>
	...
	<div class="configurator-header">
		<div class="container">
			<div class="row">
				...
				<div class="picture show-on-expand text-center"><img alt="" src="https://www.mcdelivery.co.kr/kr//static/1656543919591/assets/00/img/wos_condiment.jpg" /></div>
				<div class="description">
											...
											<div class="modal-body">
												<div class="row">
													<div class="col-xs-3 timer-wrapper">
														...
														<div class="time timer text-din timer-clock session-timer">14:49</div>
...
/*<![CDATA[*/
	...
	$(document.body).menuswitchtimer({
	    duration: 60114000, // 5 mins left to menu switch off
	    triggers: [
	        {
...
<div class="ui-selectmenu-menu hide-default-error" style="z-index: 1042; top: 0px; left: 0px;"><ul class="ui-widget ui-widget-content ui-selectmenu-menu-dropdown ui-corner-bottom" aria-hidden="true" role="listbox" aria-labelledby="form_deliveryoptions_address-button" id="form_deliveryoptions_address-menu" aria-disabled="false" tabindex="0" aria-activedescendant="ui-selectmenu-item-679" style="width: 0px; height: 305.333px;"><li role="presentation" class="ui-corner-bottom ui-selectmenu-item-selected ui-selectmenu-item-focus"><a href="#nogo" tabindex="-1" role="option" aria-selected="true" id="ui-selectmenu-item-679">경기도 수원시 권선구 세류동(세류1동) 218-98 세류</a></li></ul></div><div class="ui-selectmenu-menu hide-default-error" style="z-index: 1042; top: 0px; left: 0px;"><ul class="ui-widget ui-widget-content ui-selectmenu-menu-dropdown ui-corner-bottom" aria-hidden="true" role="listbox" aria-labelledby="form_deliveryoptions_date-button" id="form_deliveryoptions_date-menu" aria-disabled="false" tabindex="0" aria-activedescendant="ui-selectmenu-item-708" style="width: 0px;"><li role="presentation" class="ui-selectmenu-item-selected ui-selectmenu-item-focus"><a href="#nogo" tabindex="-1" role="option" aria-selected="true" id="ui-selectmenu-item-708">2022/07/06</a></li><li role="presentation"><a href="#nogo" tabindex="-1" role="option" aria-selected="false">2022/07/07</a></li><li role="presentation"><a href="#nogo" tabindex="-1" role="option" aria-selected="false">2022/07/08</a></li><li role="presentation"><a href="#nogo" tabindex="-1" role="option" aria-selected="false">2022/07/09</a></li><li role="presentation"><a href="#nogo" tabindex="-1" role="option" aria-selected="false">2022/07/10</a></li><li role="presentation"><a href="#nogo" tabindex="-1" role="option" aria-selected="false">2022/07/11</a></li><li role="presentation"><a href="#nogo" tabindex="-1" role="option" aria-selected="false">2022/07/12</a></li><li role="presentation" class="ui-corner-bottom"><a href="#nogo" tabindex="-1" role="option" aria-selected="false">2022/07/13</a></li></ul></div><div class="ui-selectmenu-menu hide-default-error" style="z-index: 1042; top: 0px; left: 0px;"><ul class="ui-widget ui-widget-content ui-selectmenu-menu-dropdown ui-corner-bottom" aria-hidden="true" role="listbox" aria-labelledby="form_deliveryoptions_time-button" id="form_deliveryoptions_time-menu" aria-disabled="false" tabindex="0" aria-activedescendant="ui-selectmenu-item-526" style="width: 0px; height: 305.333px;"><li role="presentation" class="ui-selectmenu-item-selected ui-selectmenu-item-focus"><a href="#nogo" tabindex="-1" role="option" aria-selected="true" id="ui-selectmenu-item-526">배달 받으실 시간을 선택해 주세요</a></li><li role="presentation"><a href="#nogo" tabindex="-1" role="option" aria-selected="false">13:15:00</a></li><li role="presentation"><a href="#nogo" tabindex="-1" role="option" aria-selected="false">13:30:00</a></li><li role="presentation"><a href="#nogo" tabindex="-1" role="option" aria-selected="false">13:45:00</a></li><li role="presentation"><a href="#nogo" tabindex="-1" role="option" aria-selected="false">14:00:00</a></li><li role="presentation"><a href="#nogo" tabindex="-1" role="option" aria-selected="false">14:15:00</a></li><li role="presentation"><a href="#nogo" tabindex="-1" role="option" aria-selected="false">14:30:00</a></li><li role="presentation"><a href="#nogo" tabindex="-1" role="option" aria-selected="false">14:45:00</a></li><li role="presentation"><a href="#nogo" tabindex="-1" role="option" aria-selected="false">15:00:00</a></li><li role="presentation"><a href="#nogo" tabindex="-1" role="option" aria-selected="false">15:15:00</a></li><li role="presentation"><a href="#nogo" tabindex="-1" role="option" aria-selected="false">15:30:00</a></li><li role="presentation"><a href="#nogo" tabindex="-1" role="option" aria-selected="false">15:45:00</a></li><li role="presentation"><a href="#nogo" tabindex="-1" role="option" aria-selected="false">16:00:00</a></li><li role="presentation"><a href="#nogo" tabindex="-1" role="option" aria-selected="false">16:15:00</a></li><li role="presentation"><a href="#nogo" tabindex="-1" role="option" aria-selected="false">16:30:00</a></li><li role="presentation"><a href="#nogo" tabindex="-1" role="option" aria-selected="false">16:45:00</a></li><li role="presentation"><a href="#nogo" tabindex="-1" role="option" aria-selected="false">17:00:00</a></li><li role="presentation"><a href="#nogo" tabindex="-1" role="option" aria-selected="false">17:15:00</a></li><li role="presentation"><a href="#nogo" tabindex="-1" role="option" aria-selected="false">17:30:00</a></li><li role="presentation"><a href="#nogo" tabindex="-1" role="option" aria-selected="false">17:45:00</a></li><li role="presentation"><a href="#nogo" tabindex="-1" role="option" aria-selected="false">18:00:00</a></li><li role="presentation"><a href="#nogo" tabindex="-1" role="option" aria-selected="false">18:15:00</a></li><li role="presentation"><a href="#nogo" tabindex="-1" role="option" aria-selected="false">18:30:00</a></li><li role="presentation"><a href="#nogo" tabindex="-1" role="option" aria-selected="false">18:45:00</a></li><li role="presentation"><a href="#nogo" tabindex="-1" role="option" aria-selected="false">19:00:00</a></li><li role="presentation"><a href="#nogo" tabindex="-1" role="option" aria-selected="false">19:15:00</a></li><li role="presentation"><a href="#nogo" tabindex="-1" role="option" aria-selected="false">19:30:00</a></li><li role="presentation"><a href="#nogo" tabindex="-1" role="option" aria-selected="false">19:45:00</a></li><li role="presentation"><a href="#nogo" tabindex="-1" role="option" aria-selected="false">20:00:00</a></li><li role="presentation"><a href="#nogo" tabindex="-1" role="option" aria-selected="false">20:15:00</a></li><li role="presentation"><a href="#nogo" tabindex="-1" role="option" aria-selected="false">20:30:00</a></li><li role="presentation"><a href="#nogo" tabindex="-1" role="option" aria-selected="false">20:45:00</a></li><li role="presentation"><a href="#nogo" tabindex="-1" role="option" aria-selected="false">21:00:00</a></li><li role="presentation"><a href="#nogo" tabindex="-1" role="option" aria-selected="false">21:15:00</a></li><li role="presentation"><a href="#nogo" tabindex="-1" role="option" aria-selected="false">21:30:00</a></li><li role="presentation"><a href="#nogo" tabindex="-1" role="option" aria-selected="false">21:45:00</a></li><li role="presentation"><a href="#nogo" tabindex="-1" role="option" aria-selected="false">22:00:00</a></li><li role="presentation"><a href="#nogo" tabindex="-1" role="option" aria-selected="false">22:15:00</a></li><li role="presentation"><a href="#nogo" tabindex="-1" role="option" aria-selected="false">22:30:00</a></li><li role="presentation"><a href="#nogo" tabindex="-1" role="option" aria-selected="false">22:45:00</a></li><li role="presentation"><a href="#nogo" tabindex="-1" role="option" aria-selected="false">23:00:00</a></li><li role="presentation"><a href="#nogo" tabindex="-1" role="option" aria-selected="false">23:15:00</a></li><li role="presentation"><a href="#nogo" tabindex="-1" role="option" aria-selected="false">23:30:00</a></li><li role="presentation" class="ui-corner-bottom"><a href="#nogo" tabindex="-1" role="option" aria-selected="false">23:45:00</a></li></ul></div><div class="ui-selectmenu-menu" style="z-index: 1042; top: 0px; left: 0px;"><ul class="ui-widget ui-widget-content ui-selectmenu-menu-dropdown ui-corner-bottom" aria-hidden="true" role="listbox" aria-labelledby="form_deliverystores_store-button" id="form_deliverystores_store-menu" aria-disabled="false" tabindex="0" aria-activedescendant="ui-selectmenu-item-507" style="width: 0px;"><li role="presentation" class="ui-corner-bottom ui-selectmenu-item-selected ui-selectmenu-item-focus"><a href="#nogo" tabindex="-1" role="option" aria-selected="true" id="ui-selectmenu-item-507"></a></li></ul></div>
<div id="wp_tg_cts" style="display:none;"><script id="wp_tag_script_1657073286846" src="https://astg.widerplanet.com/delivery/wpc.php?v=1&amp;ver=4.0&amp;r=1&amp;md=bs&amp;ga=1h9ugj9-1v5931-3-1&amp;wp_uid=2-70c39d7f57c608b219ed1064c6d170ed-s1645941988.865640%7Cwindows_10%7Cchrome-1kjz19z&amp;ty=Item&amp;ti=28160&amp;i0=%EC%83%81%ED%92%88ID&amp;t0=%EC%83%81%ED%92%88%EB%AA%85&amp;device=web&amp;charset=UTF-8&amp;tc=1657073286846&amp;ref=https%3A%2F%2Fwww.mcdelivery.co.kr%2Fkr%2Fmenu.html&amp;loc=https%3A%2F%2Fwww.mcdelivery.co.kr%2Fkr%2Fmenu.html%3FdaypartId%3D1%26catId%3D11"></script></div>
...
<script type="text/javascript" src="//static.tagmanager.toast.com/tag/view/572"></script>
<script type="text/javascript">var c=google_tag_manager["GTM-KM4PZ8"].macro(12);window.ne_tgm_q=window.ne_tgm_q||[];window.ne_tgm_q.push({tagType:"visit",device:c,pageEncoding:"utf-8"});</script></div>
<iframe id="ne_tgmiframe_0" width="0" height="0" style="position:absolute;width:0px;height:0px;display:none;" src="about:blank"></iframe><iframe id="ne_tgmiframe_1" width="0" height="0" style="position:absolute;width:0px;height:0px;display:none;" src="about:blank"></iframe></body></html>
